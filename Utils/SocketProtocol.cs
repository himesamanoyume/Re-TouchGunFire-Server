...
namespace SocketProtocol {
  ...
  public static partial class SocketProtocolReflection {
    ...
    static SocketProtocolReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "ChRTb2NrZXRQcm90b2NvbC5wcm90bxIOU29ja2V0UHJvdG9jb2wihQYKCE1h",
            ...
            "IAEoCzIdLlNvY2tldFByb3RvY29sLkVxdWlwSXRlbVBhY2sSNgoOQXR0YWNr",
            "QXJlYVBhY2sYDiABKAsyHi5Tb2NrZXRQcm90b2NvbC5BdHRhY2tBcmVhUGFj",
            "axIuCgpIaXRSZWdQYWNrGA8gASgLMhouU29ja2V0UHJvdG9jb2wuSGl0UmVn",
            "UGFjayKMAQoJRW5lbXlQYWNrEg0KBUZsb29yGAEgASgFEgsKA1BvcxgCIAEo",
            "BRIUCgxDdXJyZW50QXJtb3IYAyABKAISEAoITWF4QXJtb3IYBCABKAISFQoN",
            "Q3VycmVudEhlYWx0aBgFIAEoAhIRCglNYXhIZWFsdGgYBiABKAISEQoJRW5l",
            "bXlOYW1lGAcgASgJIqcBCgpIaXRSZWdQYWNrEhQKDEhpdFNlbmRlclVpZBgB",
            "IAEoBRINCgVGbG9vchgCIAEoBRILCgNQb3MYAyABKAUSDgoGRGFtYWdlGAQg",
            "ASgCEhEKCUlzTWFpbkd1bhgFIAEoCBIQCghJc1N0cmlrZRgGIAEoCBIOCgZJ",
            "c0RlYWQYByABKAgSDgoGSXNDcml0GAggASgIEhIKCklzSGVhZHNob3QYCSAB",
            "KAgihgEKDkF0dGFja0FyZWFQYWNrEhIKCkFyZWFOdW1iZXIYASABKAUSDAoE",
            "V2F2ZRgCIAEoBRIsCglFbmVteVBhY2sYAyADKAsyGS5Tb2NrZXRQcm90b2Nv",
            "bC5FbmVteVBhY2sSFQoNVGVhbU1hc3RlclVpZBgEIAEoBRINCgVJc0VuZBgF",
            "IAEoCCJFCgxSZWdpc3RlclBhY2sSDwoHQWNjb3VudBgBIAEoCRIQCghQYXNz",
            "d29yZBgCIAEoCRISCgpQbGF5ZXJOYW1lGAMgASgJIjsKCUxvZ2luUGFjaxIL",
            "CgNVaWQYASABKAUSDwoHQWNjb3VudBgCIAEoCRIQCghQYXNzd29yZBgDIAEo",
            "CSKxAgoOUGxheWVySW5mb1BhY2sSCwoDVWlkGAEgASgFEhIKClBsYXllck5h",
            ...
            "dW5QYWNrEhAKCElzT25saW5lGAcgASgIEg4KBklzVGVhbRgIIAEoCBIUCgxJ",
            "c1RlYW1NYXN0ZXIYCSABKAgSEgoKSXNTYW1lVGVhbRgKIAEoCBIPCgdEaWFt",
            "b25kGAsgASgCEgwKBENvaW4YDCABKAMSDgoGSXNEZWFkGA0gASgIIucBCgxU",
            "ZWFtbWF0ZVBhY2sSEQoJU2VuZGVyVWlkGAEgASgFEhEKCVRhcmdldFVpZBgC",
            "IAEoBRINCgVTdGF0ZRgDIAEoBRIVCg1UZWFtTWFzdGVyVWlkGAQgASgFEhoK",
            "EkxlYXZlVGVhbVBsYXllclVpZBgFIAEoBRIZChFKb2luVGVhbVBsYXllclVp",
            "ZBgGIAEoBRIVCg1UZWFtbWF0ZUNvdW50GAcgASgFEhIKClNlbmRlck5hbWUY",
            "CCABKAkSEgoKVGFyZ2V0TmFtZRgJIAEoCRIVCg1UZWFtTWVtYmVyVWlkGAog",
            "ASgFInQKDFNob3BwaW5nUGFjaxILCgNVaWQYASABKAUSEQoJSXNEaWFtb25k",
            "GAIgASgIEg0KBVByaWNlGAMgASgCEg4KBkl0ZW1JZBgEIAEoBRIUCgxEaWFt",
            "b25kUHJpY2UYBSABKAISDwoHUGVyY2VudBgGIAEoAiIsCg1FcXVpcEl0ZW1Q",
            "YWNrEgsKA1VpZBgBIAEoBRIOCgZJdGVtSWQYAiABKAUimgQKFFVwZGF0ZVBs",
            "YXllckluZm9QYWNrEgsKA1VpZBgBIAEoBRISCgpQbGF5ZXJOYW1lGAIgASgJ",
            "Eg0KBUxldmVsGAMgASgFEhEKCU1heEhlYWx0aBgEIAEoAhIQCghNYXhBcm1v",
            "chgFIAEoAhIVCg1DdXJyZW50SGVhbHRoGAYgASgCEhQKDEN1cnJlbnRBcm1v",
            "chgHIAEoAhIOCgZNYXhFeHAYCCABKAISEgoKQ3VycmVudEV4cBgJIAEoAhIY",
            "ChBCYXNlRG1nUmF0ZUJvbnVzGAogASgCEhgKEENyaXREbWdSYXRlQm9udXMY",
            "CyABKAISGAoQSGVhZHNob3REbWdCb251cxgMIAEoAhISCgpQUmF0ZUJvbnVz",
            "GA0gASgCEhAKCEFiZUJvbnVzGA4gASgCEhIKCkFyRG1nQm9udXMYDyABKAIS",
            "EwoLRG1yRG1nQm9udXMYECABKAISEwoLU21nRG1nQm9udXMYESABKAISEgoK",
            "U2dEbWdCb251cxgSIAEoAhISCgpNZ0RtZ0JvbnVzGBMgASgCEhIKClNyRG1n",
            "Qm9udXMYFCABKAISEgoKSGdEbWdCb251cxgVIAEoAhIPCgdEaWFtb25kGBYg",
            "ASgCEgwKBENvaW4YFyABKAISFAoMQ3JpdERtZ0JvbnVzGBggASgCEhUKDVRl",
            "YW1NYXN0ZXJVaWQYGSABKAUSDgoGSXNEZWFkGBogASgIIqoFCg1FcXVpcG1l",
            "bnRQYWNrEg4KBkl0ZW1JZBgBIAEoBRIVCg1FcXVpcG1lbnROYW1lGAIgASgJ",
            "EhUKDUVxdWlwbWVudFN1aXQYAyABKAkSEAoIU3ViUHJvcDEYBCABKAkSFQoN",
            "U3ViUHJvcDFWYWx1ZRgFIAEoAhIQCghTdWJQcm9wMhgGIAEoCRIVCg1TdWJQ",
            "cm9wMlZhbHVlGAcgASgCEhAKCFN1YlByb3AzGAggASgJEhUKDVN1YlByb3Az",
            "VmFsdWUYCSABKAISMQoHVGFsZW50MRgKIAEoDjIgLlNvY2tldFByb3RvY29s",
            "LkVFcXVpcG1lbnRUYWxlbnQSMQoHVGFsZW50MhgLIAEoDjIgLlNvY2tldFBy",
            "b3RvY29sLkVFcXVpcG1lbnRUYWxlbnQSCwoDVXNlGAwgASgIEg0KBUJsb2Nr",
            "ASgCIkcKC0ZyaWVuZHNQYWNrEhIKClBsYXllcjFVaWQYASABKAUSEgoKUGxh",
            "eWVyMlVpZBgCIAEoBRIQCghJc0ZyaWVuZBgDIAEoBSIwChVTZW5kUmVxdWVz",
            "dEZyaWVuZFBhY2sSFwoPVGFyZ2V0UGxheWVyVWlkGAEgASgFKkoKC1JlcXVl",
            "c3RDb2RlEg8KC1JlcXVlc3ROb25lEAASCAoEVXNlchABEgoKBkdhbWluZxAC",
            "EggKBFRlYW0QAxIKCgZGcmllbmQQBCqOCAoKQWN0aW9uQ29kZRIOCgpBY3Rp",
            "b25Ob25lEAASDAoIUmVnaXN0ZXIQARIJCgVMb2dpbhACEhIKDkluaXRQbGF5",
            "ZXJJbmZvEAMSEgoOQWNjZXB0Sm9pblRlYW0QBBIOCgpVcGRhdGVUZWFtEAUS",
            "DQoJTGVhdmVUZWFtEAYSFAoQVXBkYXRlUGxheWVySW5mbxAHEg8KC1JlYWR5",
            "QXR0YWNrEAgSDwoLU3RhcnRBdHRhY2sQCRINCglOZXh0RW5lbXkQChINCglF",
            "bmRBdHRhY2sQCxIMCghFeGl0R2FtZRAMEg0KCUJyZWFrVGVhbRANEg4KCkdl",
            "dEZyaWVuZHMQDhIUChBHZXRGcmllbmRSZXF1ZXN0EA8SEAoMU2VhcmNoRnJp",
            "ZW5kEBASFQoRU2VuZFJlcXVlc3RGcmllbmQQERIVChFHZXRQbGF5ZXJCYXNl",
            "SW5mbxASEhAKDERlbGV0ZUZyaWVuZBATEhcKE0FjY2VwdEZyaWVuZFJlcXVl",
            "c3QQFBIXChNSZWZ1c2VGcmllbmRSZXF1ZXN0EBUSDgoKSW52aXRlVGVhbRAW",
            "Eg8KC0ludml0ZWRUZWFtEBcSEwoPSm9pblRlYW1SZXF1ZXN0EBgSFAoQQWNj",
            "ZXB0SW52aXRlVGVhbRAZEhYKEkFjY2VwdGVkSW52aXRlVGVhbRAaEhQKEFJl",
            "ZnVzZUludml0ZVRlYW0QGxIVChFSZWZ1c2VkSW52aXRlVGVhbRAcEg4KCktp",
            "Y2tQbGF5ZXIQHRIQCgxHZXRUZWFtbWF0ZXMQHhIVChFUZWFtbWF0ZUxlYXZl",
            "VGVhbRAfEhIKDlBsYXllckpvaW5UZWFtECASFAoQQWNjZXB0ZWRKb2luVGVh",
            "bRAhEhIKDlJlZnVzZUpvaW5UZWFtECISEwoPUmVmdXNlZEpvaW5UZWFtECMS",
            "EwoPQmVLaWNrZWRPdXRUZWFtECQSEAoMUmVnZW5lcmF0aW9uECUSDAoIU2hv",
            "cHBpbmcQJhIPCgtHZXRJdGVtSW5mbxAnEhYKElJlZnJlc2hJdGVtU3ViUHJv",
            "cBAoEg0KCUVxdWlwSXRlbRApEhYKElJlZnJlc2hHdW5Db3JlUHJvcBAqEhUK",
            "EVVubG9ja0l0ZW1TdWJQcm9wECsSCgoGSGl0UmVnECwSEAoMQXR0YWNrSW52",
            "aXRlEC0SFQoRQ2FuY2VsUmVhZHlBdHRhY2sQLhIOCgpBdHRhY2tBcmVhEC8S",
            "b251c1N1YlByb3AQAxIbChdoZWFkc2hvdERtZ0JvbnVzU3ViUHJvcBAEEhUK",
            "EXBSYXRlQm9udXNTdWJQcm9wEAUSEwoPYWJlQm9udXNTdWJQcm9wEAYSFQoR",
            "YXJEbWdCb251c1N1YlByb3AQBxIWChJkbXJEbWdCb251c1N1YlByb3AQCBIW",
            "ChJzbWdEbWdCb251c1N1YlByb3AQCRIVChFzZ0RtZ0JvbnVzU3ViUHJvcBAK",
            "EhUKEXNyRG1nQm9udXNTdWJQcm9wEAsSFQoRbWdEbWdCb251c1N1YlByb3AQ",
            "DBIVChFoZ0RtZ0JvbnVzU3ViUHJvcBANEhAKDEVTdWJQcm9wTnVsbBAOKkgK",
            "EEVFcXVpcG1lbnRUYWxlbnQSGQoVVGVzdDFFcXVpcG1lbnRUYWxlbnQxEAAS",
            "GQoVVGVzdDFFcXVpcG1lbnRUYWxlbnQyEAFiBnByb3RvMw=="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(new[] {typeof(global::SocketProtocol.RequestCode), typeof(global::SocketProtocol.ActionCode), typeof(global::SocketProtocol.ReturnCode), typeof(global::SocketProtocol.EGunName), typeof(global::SocketProtocol.EGunType), typeof(global::SocketProtocol.EGunCoreProp), typeof(global::SocketProtocol.EEquipmentSuit), typeof(global::SocketProtocol.EEquipmentName), typeof(global::SocketProtocol.ESubProp), typeof(global::SocketProtocol.EEquipmentTalent), }, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::SocketProtocol.MainPack), global::SocketProtocol.MainPack.Parser, new[]{ "RequestCode", "ActionCode", "ReturnCode", "RegisterPack", "LoginPack", "Uid", "PlayerInfoPack", "FriendsPack", "SendRequestFriendPack", "UpdatePlayerInfoPack", "TeammatePack", "ShoppingPack", "EquipItemPack", "AttackAreaPack", "HitRegPack" }, null, null, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::SocketProtocol.EnemyPack), global::SocketProtocol.EnemyPack.Parser, new[]{ "Floor", "Pos", "CurrentArmor", "MaxArmor", "CurrentHealth", "MaxHealth", "EnemyName" }, null, null, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::SocketProtocol.HitRegPack), global::SocketProtocol.HitRegPack.Parser, new[]{ "HitSenderUid", "Floor", "Pos", "Damage", "IsMainGun", "IsStrike", "IsDead", "IsCrit", "IsHeadshot" }, null, null, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::SocketProtocol.AttackAreaPack), global::SocketProtocol.AttackAreaPack.Parser, new[]{ "AreaNumber", "Wave", "EnemyPack", "TeamMasterUid", "IsEnd" }, null, null, null, null),
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::SocketProtocol.PlayerInfoPack), global::SocketProtocol.PlayerInfoPack.Parser, new[]{ "Uid", "PlayerName", "Level", "CurrentExp", "EquipmentPacks", "GunPacks", "IsOnline", "IsTeam", "IsTeamMaster", "IsSameTeam", "Diamond", "Coin", "IsDead" }, null, null, null, null),
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::SocketProtocol.UpdatePlayerInfoPack), global::SocketProtocol.UpdatePlayerInfoPack.Parser, new[]{ "Uid", "PlayerName", "Level", "MaxHealth", "MaxArmor", "CurrentHealth", "CurrentArmor", "MaxExp", "CurrentExp", "BaseDmgRateBonus", "CritDmgRateBonus", "HeadshotDmgBonus", "PRateBonus", "AbeBonus", "ArDmgBonus", "DmrDmgBonus", "SmgDmgBonus", "SgDmgBonus", "MgDmgBonus", "SrDmgBonus", "HgDmgBonus", "Diamond", "Coin", "CritDmgBonus", "TeamMasterUid", "IsDead" }, null, null, null, null),
  ...
  public enum ActionCode {
    ...
    ///命中注册
    /// </summary>
    [pbr::OriginalName("HitReg")] HitReg = 44,
    /// <summary>
    ///队长发起出击请求
    /// </summary>
  ...
  public sealed partial class MainPack : pb::IMessage<MainPack> {
    ...
    public MainPack(MainPack other) : this() {
      ...
      attackAreaPack_ = other.attackAreaPack_ != null ? other.attackAreaPack_.Clone() : null;
      hitRegPack_ = other.hitRegPack_ != null ? other.hitRegPack_.Clone() : null;
    ...
    /// <summary>Field number for the "AttackAreaPack" field.</summary>
    public const int AttackAreaPackFieldNumber = 14;
    private global::SocketProtocol.AttackAreaPack attackAreaPack_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::SocketProtocol.AttackAreaPack AttackAreaPack {
      get { return attackAreaPack_; }
      set {
        attackAreaPack_ = value;
      }
    }

    /// <summary>Field number for the "HitRegPack" field.</summary>
    public const int HitRegPackFieldNumber = 15;
    private global::SocketProtocol.HitRegPack hitRegPack_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::SocketProtocol.HitRegPack HitRegPack {
      get { return hitRegPack_; }
      set {
        hitRegPack_ = value;
      }
    }
    ...
    public bool Equals(MainPack other) {
      ...
      if (!object.Equals(AttackAreaPack, other.AttackAreaPack)) return false;
      if (!object.Equals(HitRegPack, other.HitRegPack)) return false;
    ...
    public override int GetHashCode() {
      ...
      if (attackAreaPack_ != null) hash ^= AttackAreaPack.GetHashCode();
      if (hitRegPack_ != null) hash ^= HitRegPack.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (attackAreaPack_ != null) {
        output.WriteRawTag(114);
        output.WriteMessage(AttackAreaPack);
      }
      if (hitRegPack_ != null) {
        output.WriteRawTag(122);
        output.WriteMessage(HitRegPack);
      }
      if (_unknownFields != null) {
    ...
    public int CalculateSize() {
      ...
      if (attackAreaPack_ != null) {
        size += 1 + pb::CodedOutputStream.ComputeMessageSize(AttackAreaPack);
      }
      if (hitRegPack_ != null) {
        size += 1 + pb::CodedOutputStream.ComputeMessageSize(HitRegPack);
      }
      if (_unknownFields != null) {
    ...
    public void MergeFrom(MainPack other) {
      ...
      if (other.attackAreaPack_ != null) {
        if (attackAreaPack_ == null) {
          AttackAreaPack = new global::SocketProtocol.AttackAreaPack();
        }
        AttackAreaPack.MergeFrom(other.AttackAreaPack);
      }
      if (other.hitRegPack_ != null) {
        if (hitRegPack_ == null) {
          HitRegPack = new global::SocketProtocol.HitRegPack();
        }
        HitRegPack.MergeFrom(other.HitRegPack);
      }
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 114: {
            ...
            input.ReadMessage(AttackAreaPack);
            break;
          }
          case 122: {
            if (hitRegPack_ == null) {
  ...
  public sealed partial class EnemyPack : pb::IMessage<EnemyPack> {
    private static readonly pb::MessageParser<EnemyPack> _parser = new pb::MessageParser<EnemyPack>(() => new EnemyPack());
    private pb::UnknownFieldSet _unknownFields;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public static pb::MessageParser<EnemyPack> Parser { get { return _parser; } }
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public EnemyPack(EnemyPack other) : this() {
      floor_ = other.floor_;
      pos_ = other.pos_;
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public EnemyPack Clone() {
      return new EnemyPack(this);
    }
    ...
    public const int EnemyNameFieldNumber = 7;
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public override bool Equals(object other) {
      return Equals(other as EnemyPack);
    }

    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public bool Equals(EnemyPack other) {
      if (ReferenceEquals(other, null)) {
        return false;
      }
      if (ReferenceEquals(other, this)) {
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public void MergeFrom(EnemyPack other) {
      if (other == null) {
        return;
      }
      if (other.Floor != 0) {
  ...
  public sealed partial class HitRegPack : pb::IMessage<HitRegPack> {
    private static readonly pb::MessageParser<HitRegPack> _parser = new pb::MessageParser<HitRegPack>(() => new HitRegPack());
    private pb::UnknownFieldSet _unknownFields;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public static pb::MessageParser<HitRegPack> Parser { get { return _parser; } }
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public HitRegPack(HitRegPack other) : this() {
      hitSenderUid_ = other.hitSenderUid_;
      floor_ = other.floor_;
      pos_ = other.pos_;
      damage_ = other.damage_;
      isMainGun_ = other.isMainGun_;
      isStrike_ = other.isStrike_;
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public HitRegPack Clone() {
      return new HitRegPack(this);
    }

    /// <summary>Field number for the "HitSenderUid" field.</summary>
    public const int HitSenderUidFieldNumber = 1;
    private int hitSenderUid_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public int HitSenderUid {
      get { return hitSenderUid_; }
      set {
        hitSenderUid_ = value;
      }
    }
    ...
    /// <summary>Field number for the "IsMainGun" field.</summary>
    public const int IsMainGunFieldNumber = 5;
    private bool isMainGun_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public bool IsMainGun {
      get { return isMainGun_; }
      set {
        isMainGun_ = value;
      }
    }

    /// <summary>Field number for the "IsStrike" field.</summary>
    public const int IsStrikeFieldNumber = 6;
    private bool isStrike_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public bool IsStrike {
      get { return isStrike_; }
      set {
        isStrike_ = value;
      }
    }
    ...
    public const int IsCritFieldNumber = 8;
    ...
    public const int IsHeadshotFieldNumber = 9;
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public override bool Equals(object other) {
      return Equals(other as HitRegPack);
    }

    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public bool Equals(HitRegPack other) {
      if (ReferenceEquals(other, null)) {
        return false;
      }
      if (ReferenceEquals(other, this)) {
      ...
      if (HitSenderUid != other.HitSenderUid) return false;
      if (Floor != other.Floor) return false;
      if (Pos != other.Pos) return false;
      if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(Damage, other.Damage)) return false;
      if (IsMainGun != other.IsMainGun) return false;
      if (IsStrike != other.IsStrike) return false;
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (HitSenderUid != 0) hash ^= HitSenderUid.GetHashCode();
      if (Floor != 0) hash ^= Floor.GetHashCode();
      if (Pos != 0) hash ^= Pos.GetHashCode();
      if (Damage != 0F) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(Damage);
      if (IsMainGun != false) hash ^= IsMainGun.GetHashCode();
      if (IsStrike != false) hash ^= IsStrike.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      if (HitSenderUid != 0) {
        output.WriteRawTag(8);
        output.WriteInt32(HitSenderUid);
      }
      if (Floor != 0) {
        output.WriteRawTag(16);
        output.WriteInt32(Floor);
      ...
      if (IsMainGun != false) {
        ...
        output.WriteBool(IsMainGun);
      }
      if (IsStrike != false) {
        output.WriteRawTag(48);
        output.WriteBool(IsStrike);
      }
      if (IsDead != false) {
    ...
    public int CalculateSize() {
      int size = 0;
      if (HitSenderUid != 0) {
        size += 1 + pb::CodedOutputStream.ComputeInt32Size(HitSenderUid);
      }
      if (Floor != 0) {
        size += 1 + pb::CodedOutputStream.ComputeInt32Size(Floor);
      }
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public void MergeFrom(HitRegPack other) {
      if (other == null) {
        return;
      }
      if (other.HitSenderUid != 0) {
        HitSenderUid = other.HitSenderUid;
      }
      if (other.Floor != 0) {
        Floor = other.Floor;
      }
      ...
      if (other.IsMainGun != false) {
        IsMainGun = other.IsMainGun;
      }
      if (other.IsStrike != false) {
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 40: {
            IsMainGun = input.ReadBool();
            break;
          }
          case 48: {
            IsStrike = input.ReadBool();
            break;
          }
          case 56: {
  ...
  public sealed partial class AttackAreaPack : pb::IMessage<AttackAreaPack> {
    private static readonly pb::MessageParser<AttackAreaPack> _parser = new pb::MessageParser<AttackAreaPack>(() => new AttackAreaPack());
    private pb::UnknownFieldSet _unknownFields;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public static pb::MessageParser<AttackAreaPack> Parser { get { return _parser; } }
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public AttackAreaPack(AttackAreaPack other) : this() {
      areaNumber_ = other.areaNumber_;
      wave_ = other.wave_;
      enemyPack_ = other.enemyPack_.Clone();
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public AttackAreaPack Clone() {
      return new AttackAreaPack(this);
    }

    /// <summary>Field number for the "AreaNumber" field.</summary>
    public const int AreaNumberFieldNumber = 1;
    private int areaNumber_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    ...
    /// <summary>Field number for the "EnemyPack" field.</summary>
    public const int EnemyPackFieldNumber = 3;
    private static readonly pb::FieldCodec<global::SocketProtocol.EnemyPack> _repeated_enemyPack_codec
        = pb::FieldCodec.ForMessage(26, global::SocketProtocol.EnemyPack.Parser);
    private readonly pbc::RepeatedField<global::SocketProtocol.EnemyPack> enemyPack_ = new pbc::RepeatedField<global::SocketProtocol.EnemyPack>();
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::RepeatedField<global::SocketProtocol.EnemyPack> EnemyPack {
      get { return enemyPack_; }
    }
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public override bool Equals(object other) {
      return Equals(other as AttackAreaPack);
    }

    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public bool Equals(AttackAreaPack other) {
      if (ReferenceEquals(other, null)) {
        return false;
      }
      if (ReferenceEquals(other, this)) {
      ...
      if(!enemyPack_.Equals(other.enemyPack_)) return false;
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (AreaNumber != 0) hash ^= AreaNumber.GetHashCode();
      if (Wave != 0) hash ^= Wave.GetHashCode();
      hash ^= enemyPack_.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      if (AreaNumber != 0) {
        output.WriteRawTag(8);
        output.WriteInt32(AreaNumber);
      }
      if (Wave != 0) {
        output.WriteRawTag(16);
        output.WriteInt32(Wave);
      }
      enemyPack_.WriteTo(output, _repeated_enemyPack_codec);
      if (TeamMasterUid != 0) {
    ...
    public int CalculateSize() {
      int size = 0;
      if (AreaNumber != 0) {
        size += 1 + pb::CodedOutputStream.ComputeInt32Size(AreaNumber);
      }
      if (Wave != 0) {
        size += 1 + pb::CodedOutputStream.ComputeInt32Size(Wave);
      }
      size += enemyPack_.CalculateSize(_repeated_enemyPack_codec);
      if (TeamMasterUid != 0) {
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public void MergeFrom(AttackAreaPack other) {
      if (other == null) {
        return;
      }
      if (other.AreaNumber != 0) {
        AreaNumber = other.AreaNumber;
      }
      if (other.Wave != 0) {
        Wave = other.Wave;
      }
      enemyPack_.Add(other.enemyPack_);
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 26: {
            enemyPack_.AddEntriesFrom(input, _repeated_enemyPack_codec);
            break;
          }
          case 32: {
  ...
  public sealed partial class UpdatePlayerInfoPack : pb::IMessage<UpdatePlayerInfoPack> {
    ...
    /// <summary>Field number for the "TeamMasterUid" field.</summary>
    public const int TeamMasterUidFieldNumber = 25;
    private int teamMasterUid_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public int TeamMasterUid {
      get { return teamMasterUid_; }
    ...
    /// <summary>Field number for the "IsDead" field.</summary>
    public const int IsDeadFieldNumber = 26;
    private bool isDead_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public bool IsDead {
      get { return isDead_; }
    ...
    public int CalculateSize() {
      ...
      if (TeamMasterUid != 0) {
        size += 2 + pb::CodedOutputStream.ComputeInt32Size(TeamMasterUid);
      }
      if (IsDead != false) {
        size += 2 + 1;
      }
